...
public class Main {
    public static void main(String[] args) {
        HitunganLingkaran h1= new HitunganLingkaran(27, 3.14);
        h1.show();
        HitunganLingkaran h2= new HitunganLingkaran(16, 3.14);
        h2.show();
        HitunganLingkaran h3= new HitunganLingkaran(19, 3.14);
        h3.show();
